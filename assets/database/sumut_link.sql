...
-- Dumping data for table sumut_link.nasabah: ~11 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `transaksi` (
  ...
  CONSTRAINT `FK_transaksi_nasabah` FOREIGN KEY (`nasabah_id`) REFERENCES `nasabah` (`nik_ktp`),
  CONSTRAINT `FK_transaksi_users` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
