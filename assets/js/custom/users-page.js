document.addEventListener("DOMContentLoaded", function () {
  ...
  const modalToggleButtons = document.querySelectorAll('[data-modal-toggle="add-users-modal"]');
  ...
  modal.addEventListener("click", (event) => {
    if (
      ...
      event.target.closest('[data-modal-toggle="add-users-modal"]') // Clicking close button
    ) {
      updateSidenavZIndex(990);
    }
  });
