document.addEventListener("DOMContentLoaded", function () {
  ...
  const modalToggleButtons = document.querySelectorAll('[data-modal-toggle="change-password"]');
  ...
  modal.addEventListener("click", (event) => {
    if (
      ...
      event.target.closest('[data-modal-toggle="change-password"]') // Clicking close button
    ) {
      updateSidenavZIndex(990);
    }
  });
